...
@click.command()
@click.option(
    "--galaxy_workbench", default="http://nginx:90", help="The targeted Galaxy instance"
)
@click.option(
    "--user",
    default="admin@galaxy_workbench.org",
    help="The username to use accessing the galaxy_workbench instance",
)
...
def singularity_images(illumina_version, nanopore_version):
    ...
    plugin_versions = {
        "irida_workbench-plugin-sars-cov-2-illumina": illumina_version,
        "irida_workbench-plugin-sars-cov-2-nanopore": nanopore_version,
    }
    # download plugins
...
def pangolin():
    """
    This command installs the pangolin tool in galaxy_workbench
    """
    pass
...
def nanopore():
    """
    This command installs the nanopore tool in galaxy_workbench
    """
    pass
